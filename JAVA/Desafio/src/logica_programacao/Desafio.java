...
public class Desafio {
	...
	public static void main(String[] args) {
		...
		if(categoria == 'C') {
			...
			System.out.println("Não foi possível calcular os valores dos produtos: ");
		}
		...
		System.out.printf("Produtos [Eletrodomésticos] em estoque: %d | Valor Total: %.2f | Lucro: %.2f\n",quantidadeE, totalEstoqueE, lucroE);
		System.out.printf("Produtos [Vestuário] em estoque: %d | Valor Total: %.1f | Lucro: %.2f\n",quantidadeV , totalEstoqueV, lucroV);
